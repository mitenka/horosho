...
- Напоминания о заполнении дневниковой карточки: ежедневное уведомление с настраиваемым временем, выключено по умолчанию; не приходит, если дневник за сегодня уже отмечен заполненным

## [1.4.0] - 2026-07-18

### Added

- Поле «Комментарий» в дневниковой карточке — свободная заметка о дне: триггеры, контекст эмоций и использования навыков
- Комментарии за выбранный период включаются в PDF-экспорт отдельным блоком

### Fixed

- Исправлена потеря данных дня (состояние, оценка навыков, отметка заполнения) при снятии последней отметки поведения за день
