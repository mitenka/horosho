...
const UsedSkills = () => {
  ...
  const skillDescriptions = {
    ...
    "**Радикальное принятие**":
      "Полное принятие реальности такой, какая она есть, без борьбы с тем, что невозможно изменить. Это не означает одобрение ситуации или пассивность — это прекращение внутренней войны с фактами. Принятие освобождает энергию для конструктивных действий там, где изменения возможны.",
    ...
    "**DEAR:** объективная эффективность":
      "Структурированный способ формулировать просьбы и отказы: опишите ситуацию только фактами без интерпретаций, выразите свои чувства («я чувствую...»), четко скажите, чего именно вы хотите или в чём нуждаетесь, объясните положительные результаты выполнения просьбы. Эта структура помогает быть понятым и повышает шансы получить желаемое.",
    "**MAN:** осознанность в достижении цели":
      "Принципы поведения во время важных разговоров: сохраняйте осознанность (фокус на цели, не отвлекайтесь на провокации), держитесь уверенно (говорите спокойным голосом, поддерживайте зрительный контакт), будьте готовы к переговорам (ищите компромиссы, учитывайте интересы собеседника). Это помогает донести свою точку зрения и добиться результата.",
