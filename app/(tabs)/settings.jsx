      ...
      >
        ...
        <View style={styles.actionsContainer}>
          ...
          <View style={styles.contactSection}>
            ...
            <Text style={styles.infoText}>
              А если вы готовы помочь с текстами о навыках или вопросами для
              тестов — дайте знать. Во время изучения ДПТ вы могли заметить то,
              что мы не отразили в приложении. Пожалуйста, расскажите нам об
              этом.
            </Text>
