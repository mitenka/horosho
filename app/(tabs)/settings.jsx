        ...
        <View style={styles.actionsContainer}>
          ...
          <View style={styles.contactSection}>
            ...
            <Text style={styles.infoText}>
              У нас есть мечта — описать навыки простым языком с интерактивными
              иллюстрациями и остроумными вопросами для закрепления теории, ни на
              шаг не отступая от научных материалов бабушки (так я называю
              Линехан, потому что она действительно похожа на мою бабушку).
            </Text>
            <Text style={styles.infoText}>
              Мы назвали приложение «Хорошо» и начали работать. Самой сложной
              частью оказалась не техническая реализация, а именно работа над
              адаптацией материалов. Спустя несколько месяцев я переименовал
              приложение в «Сойдёт» и решил выпустить его, продолжив работу над
              статьями и словарем. Поэтому у нас есть к вам просьба.
            </Text>
            <Text style={styles.infoText}>
              Если вы заметили неточность, у вас есть хороший пример использования
              какого-либо навыка, удачная формулировка или свежая идея,
              пожалуйста, напишите кому-нибудь из нас. Мы рассмотрим, обсудим с
              профессиональными терапевтами и внесем ваше улучшение. Это поможет
              тем, кто изучает навыки. Спасибо.
            </Text>
            <Text style={styles.infoText}>Дима</Text>
